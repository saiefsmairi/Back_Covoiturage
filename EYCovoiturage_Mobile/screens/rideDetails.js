...
const RideDetails = ({ handlePress, route }) => {
    ...
    useEffect(() => {
        ...
        const getCarInfo = async (userId) => {
            try {
                const response = await axios.get(`https://dcc6-197-0-80-111.ngrok-free.app/api/User/${route.params.trip.trip.userId}/carImage`);
        ...
        const getProfileImage = async () => {
            try {
                const response = await axios.get(`https://dcc6-197-0-80-111.ngrok-free.app/api/User/${route.params.trip.trip.userId}/profileImage`);
                const base64Image = response.data;
                setProfileImage(base64Image);
                const userResponse = await axios.get(`https://dcc6-197-0-80-111.ngrok-free.app/api/User/${route.params.trip.trip.userId}`);
        ...
        const fetchData = async () => {
            try {
                ...
                const userResponse = await axios.get(`https://dcc6-197-0-80-111.ngrok-free.app/api/User/${userId}`);
                const checkRequestExists = async () => {
                    try {
                        const response = await axios.get(`https://dcc6-197-0-80-111.ngrok-free.app/api/Trip/${route.params.trip.trip.tripId}/users/${userResponse.data.id}/check-request`);
    ...
    const createRequestRide = async () => {
        ...
        try {
            const response = await axios.post(`https://dcc6-197-0-80-111.ngrok-free.app/api/Trip/${trip.tripId}/request-rides`, requestRide);
            console.log(response.data)
