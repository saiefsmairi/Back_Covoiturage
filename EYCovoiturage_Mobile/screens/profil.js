...
export default function Profil({ navigation }) {
    ...
    React.useEffect(() => {
        ...
        const getUserById = async (userId) => {
            ...
            try {
                ...
                console.log(userId)
                const response = await axios.get(`https://4466-197-2-98-33.ngrok-free.app/api/User/${userId}`);
        ...
        const getProfileImage = async (userId) => {
            ...
            var userId = JSON.parse(value).id
            try {
                const response = await axios.get(`https://4466-197-2-98-33.ngrok-free.app/api/User/${userId}/profileImage`);
    ...
    React.useEffect(() => {
        const getCarInfo = async (userId) => {
            ...
            var userId = JSON.parse(value).id
            try {
                const response = await axios.get(`https://4466-197-2-98-33.ngrok-free.app/api/User/${userId}/carImage`);
        ...
        const getTotalpoints = async (userId) => {
            ...
            var userId = JSON.parse(value).id
            try {
                const response = await axios.get(`https://4466-197-2-98-33.ngrok-free.app/api/User/users/${userId}/TotalPoints`);
        ...
        if (!result.canceled) {
            try {
                ...
                const response = await axios.put(
                    `https://4466-197-2-98-33.ngrok-free.app/api/User/${userId}/upload`,
                    formData,
                    {
                        headers: {
    ...
    const handleSubmit = async () => {
        try {
            const response = await axios.put(`https://4466-197-2-98-33.ngrok-free.app/api/User/${userStorage.id}`, formData);
...
/*         navigation.navigate('phoneNumberVerification', {
        ...
        setShowModalVerfiyPhone(false);
            try {
             ...
             const response = await axios.post('https://4466-197-2-98-33.ngrok-free.app/api/User/sendSMSForConfirmPhone', null, {
               params: {
