...
function HomeScreen({ navigation }) {
    ...
    React.useCallback(() => {
      ...
      const fetchAceeptedTripsForPassengers = async () => {
        try {
          ...
          setIsLoading(true);
          const response = await axios.get(`https://4466-197-2-98-33.ngrok-free.app/api/Trip/passengers/${userId}/trips/accepted`);
      ...
      const fetchPublishedTripsForDrivers = async () => {
        try {
          const value = await SecureStore.getItemAsync('user');
          var userId = JSON.parse(value).id
          const response = await axios.get(`https://4466-197-2-98-33.ngrok-free.app/api/Trip/user/${userId}/trips`);
  ...
  const onRefresh = async () => {
    ...
    try {
      ...
      var userId = JSON.parse(value).id
      const response = await axios.get(`https://4466-197-2-98-33.ngrok-free.app/api/Trip/passengers/${userId}/trips/accepted`);
      const response2 = await axios.get(`https://4466-197-2-98-33.ngrok-free.app/api/Trip/user/${userId}/trips`);
      setTrips(response.data);
